...
<body class="bg-dark text-white">
    <form class="w-75 mt-5 mx-auto p-4 border shadow-sm bg-secondary" method="GET" action="form_belanja.php">
        ...
        <div class="container px-3">
            <div class="form-group mt-3 row">
                ...
                <div class="col-8">
                    <input id="custname" placeholder="Masukan nama customer" type="text" name="customer_name" class="form-control" required>
                </div>
            </div>
            <div class="form-group mt-3 row">
                ...
                <div class="col-8">
                    ...
                    <div class="custom-control custom-radio custom-control-inline">
                        <input value="jam" name="produk" id="jamtangan" type="radio" class="custom-control-input" required>
    ...
    <?php
    if (isset($_GET['submit'])) { //Error Handling
